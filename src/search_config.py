"""
Centralized search dictionaries and tunables.
"""
...
NOISY_COMPONENT_TERMS = {
    "working", "feel", "maybe", "small", "looking", "away", "updated", "bit",
    "month", "months", "need", "things", "thing", "im", "ive", "dont", "didnt",
    "uk", "usa", "eastern", "europe", "science",
}
