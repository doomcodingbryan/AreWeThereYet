...
const PLACEHOLDERS = [
  "warm weather, low cost of living, safe for families...",
  "tech hub with high quality of life...",
  "English-speaking country, easy visa process...",
  "Mediterranean climate, affordable healthcare...",
  "strong economy, good work-life balance...",
  "outdoor lifestyle, nature and hiking...",
]
...
const AIChatInput = ({ value, onChange, onSubmit }: AIChatInputProps) => {
        ...
        <div className="flex items-center gap-2 p-3 rounded-full bg-white w-full">
          ...
          <div className="relative flex-1 px-3">
            <input
              ...
              className="border-0 outline-none rounded-md py-2 text-base bg-transparent w-full font-normal"
              style={{ position: "relative", zIndex: 1 }}
              onFocus={() => setIsActive(true)}
            />
            <div className="absolute left-3 top-0 w-full h-full pointer-events-none flex items-center py-2">
          ...
          <button
            className="flex items-center gap-1 bg-[#1a253b] hover:bg-[#2e3f5c] text-white p-3 rounded-full font-medium justify-center transition-colors"
            title="Search"
            type="button"
